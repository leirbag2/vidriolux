...
class ShowProductos extends Component
{
    ...
    public function render()
    {
        ...
        $productos = Productos::select('productos.id AS id','productos.codigo','productos.nombreProducto',
        'productos.descripcionProducto','productos.stock','productos.precioNeto','productos.precioIva','productos.tipo_estado_id',
        'productos.categorias_id','categorias.id AS cId','categorias.nombreCategoria','precioVenta')
